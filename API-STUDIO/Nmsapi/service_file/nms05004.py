...
def check_mysql_status():
    try:
        ...
        # Parse the result to determine the status of mysql
...
# Example usage to check mysql service status
mysql_status = check_mysql_status()
update_service_status_to_db('MYSQL SERVER', 'mysql', 'MYSQL', mysql_status)
