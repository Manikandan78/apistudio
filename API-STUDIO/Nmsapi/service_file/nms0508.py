...
def check_service_status_cms_page(service_name):
    try:
...
def update_service_status_to_db(app_name, service_name, server_name):
    ...
    running_status = check_service_status_cms_page(service_name)
...
# Example usage
update_service_status_to_db('CMSPAGE', 'Cmspage', 'NGINX')
