...
from config import DB_USER_API, DB_NAME_API, DB_PASSWORD_API
...
def custom_api():
    ...
    backup_dir = "/Backup/APISTUDIO"
    backup_log_dir = "/Backup/APISTUDIO/LOG"
    ...
    backup_file = f"{backup_dir}/PUBLIC-{timestamp}.sql"
    log_file = f"{backup_log_dir}/PUBLIC-{timestamp}.log"
