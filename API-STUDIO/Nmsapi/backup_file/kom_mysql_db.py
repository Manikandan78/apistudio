...
file_size_bytes = os.path.getsize(BACKUP_FILE) if result.returncode == 0 else 0
...
print(f"Next Backup Time: {next_backup_time}")
...
try:
    ...
    """
    data = (
        APP_NAME, "MySQL", DB_NAME, os.path.basename(BACKUP_FILE), file_size, BACKUP_DIR,
